...
def calcular_area_rectangulo(largo, ancho):
    ...
    area_resultado = largo * ancho  # Reemplaza esto con el cálculo del área usando las variables 'largo' y 'ancho'.

    # TODO: Paso 2. Devuelve el valor calculado.
    # Reemplaza 'None' con la variable que contiene el área.
    return area_resultado  # Reemplaza esto con la variable que contiene el área
